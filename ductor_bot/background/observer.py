...
class BackgroundObserver:
    ...
    def submit(
        ...
        bg_task = BackgroundTask(
            ...
            user_id=sub.user_id,
            reasoning_effort=sub.reasoning_effort_override,
            model_policy_selected=sub.model_policy_selected,
    ...
    async def _run_with_session(self, bg_task: BackgroundTask) -> None:
        ...
        try:
            request = AgentRequest(
                ...
                reasoning_effort_override=bg_task.reasoning_effort or None,
                model_policy_selected=bg_task.model_policy_selected,
                chat_id=bg_task.chat_id,
